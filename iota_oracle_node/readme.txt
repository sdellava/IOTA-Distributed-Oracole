...
- ORACLE_CONTROLLER_CAP_ID=0xa60b03ad45ed46c564ba1620b0347500b34cd082064004f4521cff0c53672dfd
- IOTA_CLOCK_ID=0x6
...
export ORACLE_CONTROLLER_CAP_ID="0xa60b03ad45ed46c564ba1620b0347500b34cd082064004f4521cff0c53672dfd"
...
iota client ptb   --move-call "${SYSTEM_PKG}::systemState::propose_task_template_upsert"   "@${CONTROLLER_CAP_ID}"   "@${STATE_ID}"   "@${CLOCK_ID}"   "$PROPOSAL_TIMEOUT_MS"   "4"   '"STORAGE"'   "1"   "500000"   "8192"   "10485760"   "10485760"   "0"   "1"   "1"   "365"   "10000"   --gas-budget "$GAS_BUDGET"
