...
VALIDATOR_CAPS_REPORT="${REPO_ROOT}/iota_oracle_move/testnet/oracle_validator_caps_testnet/testnet_validator_caps.txt"
SYSTEM_STATE_REPORT="${REPO_ROOT}/iota_oracle_move/testnet/oracle_system_state_testnet/testnet_system_state.txt"
TASKS_REPORT="${REPO_ROOT}/iota_oracle_move/testnet/oracle_tasks_testnet/testnet_oracle_tasks.txt"
...
client_env = repo_root / "iota_oracle_client" / ".env"
node_env = repo_root / "iota_oracle_node" / ".env"
webview_example = repo_root / "iota_oracle_webview" / ".env.example"
webview_env = repo_root / "iota_oracle_webview" / ".env"
