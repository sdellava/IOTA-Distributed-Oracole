...
# STORAGE pricing assumption updated on 2026-04-08:
# - reference provider: Filebase IPFS paid storage, $0.05 / GB-month
# - reference IOTA market price: $0.06016 / IOTA
# - included size: 10,485,760 bytes = 0.01048576 GB
# - replicated across 3 requested nodes
# => monthly storage ~= 26,144,681 atomic IOTA for 30 days
# => daily storage ~= 871,490 atomic IOTA
# Upload/pin requests are treated as included, so the one-time base price is 0.
TPL_STORAGE_BASE_PRICE="${TPL_STORAGE_BASE_PRICE:-0}"
...
TPL_STORAGE_PRICE_PER_DAY="${TPL_STORAGE_PRICE_PER_DAY:-871490}"
